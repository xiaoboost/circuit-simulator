...
import { PartParamEditor } from './render';
...
// /** 加载组件 */
// function mountComponent(component: React.FunctionComponentElement<any>) {
//   currentContainer && render(component, currentContainer);
// }
