...
export function Render() {
  ...
  const [isDebuggerMode] = useWatcher(configuration.debuggerMode);
  const onClickDebuggerMode = () => {
    configuration.debuggerMode.setData(!isDebuggerMode);
  };
  ...
  return (
    <>
      <Button
        onClick={onClickDebuggerMode}
        selected={isDebuggerMode}
        style={{
          marginRight: 0,
        }}
      >
